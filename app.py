...
data_arrays = {
    ...
    'c': [
        ...
        {'question': 'How do you create a function in C?,what is a function in c,functions', 
    ...
    'html': [
        {'question': 'how to create a simple HTML page?,design a simple HTML page,html page', 'answer': '<!DOCTYPE html>\n<html>\n<head>\n    <title>Title</title>\n</head>\n<body>\n    <h1>Hello World!</h1>\n</body>\n</html>'},
        {'question': 'Who is the founder of html, who invented html, html founder, father of html,when was html invented', 'answer': 'HTML was invented by Tim Berners-Lee in 1991. He created it while working at CERN as a way to structure and link information on the World Wide Web'},
        ...
        {'question': 'What is HTML Tags tags html html tags,tag in html,html tag', 'answer': ' Tags are the markup used to create elements. They are enclosed in angle brackets, e.g., <tagname>.'},
        {'question': 'What is HTML Elements,html elements,element, element in html', 'answer': 'An element consists of a start tag, content, and an end tag. Some elements are self-closing and don’t require an end tag,Structural Elements,Text Elements,Links and Images,Lists,Tables,Forms,Semantic Elements (HTML5) are some elements of html.'},
        {'question': 'What is lists in html, lists in html,list', 'answer': 'ordered ,unordered,nesting and definition are types of lists in html'},
    ]
}
